          ...
          <div class="card-body">
            <table class="table table-dark table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $item->registrations->customers->country }}</td>
                        <td>{{ $item->registrations->customers->name }}</td>
                        <td>{{ $item->registrations->customers->customer_id }}</td>
                        <td>{{ $item->registrations->file_no }}</td>
                        <td>{{ $item->no }}</td>
                        <td>{{ $item->floor }}</td>
